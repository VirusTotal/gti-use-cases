...
def get_users_without_2fa(apikey, group_id):
    ...
    Google Threat Intelligence API endpoint reference: https://gtidocs.virustotal.com/reference/groups-relationships
    '''
...
def main():
    ...
    if users_without_2fs:
        print(f'There are {len(users_without_2fs)} users without 2FA.\n')
        pprint(users_without_2fs)
    else:
        print('No users without 2FA were found.\n')
